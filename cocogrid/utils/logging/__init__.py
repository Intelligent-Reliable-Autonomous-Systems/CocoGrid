...
def capped_cubic_logging_schedule(episode_id: int) -> bool:
    """Trigger logging at the episode indices 0, 1, 8, 27, ..., :math:`k^3`, ..., 729, 1000, 2000, 3000, ...
...
class CocogridLogger(LoggingMetric):

    def __init__(self, label_prefix: str = 'cocogrid') -> None:
        self.label_prefix = label_prefix
...
from cocogrid.utils.logging.heatmap_logger import HeatmapLogger, get_cocogrid_heatmap_loggers