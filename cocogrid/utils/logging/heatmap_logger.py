...
def get_cocogrid_extent(env: gym.Env, without_border: bool = True):
...
def get_cocogrid_heatmap_loggers(env: gym.Env, decay: float = 1, gamma: float = 1, without_border: bool = True) -> List[HeatmapLogger]:
    loggers = []
    extent = get_cocogrid_extent(env, without_border=without_border)
